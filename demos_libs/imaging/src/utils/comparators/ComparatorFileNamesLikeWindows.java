 ...
 * @author Alan Moore
 */
public class ComparatorFileNamesLikeWindows implements Comparator {
    ...
    public int compare(Object o1, Object o2) {
        ...
        String nomeFile1=null, nomeFile2=null;

        if (o1 instanceof File) {
            nomeFile1 = ((File) o1).getName();
            nomeFile2 = ((File) o2).getName();
        }
    ...
    private int compareOther(boolean isLetters) {
        ...
        if (isLetters) {
            ...
            return ch1 - ch2;
            //*/
            return defaultCollator.compare(String.valueOf(ch1), String.valueOf(ch2));
        } else {
            //return defaultCollator.compare(String.valueOf(ch1), String.valueOf(ch2));
            return ch1 - ch2;
        }
