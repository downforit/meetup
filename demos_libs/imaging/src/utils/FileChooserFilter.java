...
public class FileChooserFilter extends FileFilter {
    ...
    /**
     * Return a list of the accepted extension
     * @see getExtension
     * @see FileFilteraccepts
     */
    public String[] getAcceptedExtensions() {
        int htCount=filters.size(),current=0;
        String[] acceptedExtensions = new String[htCount];


        if (filters!=null) {
            Enumeration extList = filters.keys();
            while(extList.hasMoreElements()) {
                acceptedExtensions[current]=(String) extList.nextElement();
                current++;
            }
